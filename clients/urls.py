...
urlpatterns = [
    path("", views.ClientGenericAPIView.as_view(), name="client_generic_view"),
    path(
        "<client_id>/", views.ClientGenericAPIView.as_view(), name="client_generic_view"
    ),
    ...
    path("<username>/", views.ClientGenericAPIView.as_view(), name="client_details"),

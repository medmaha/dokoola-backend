...
class Milestone(models.Model):
    ...
    acknowledgement = models.ForeignKey(Acknowledgement, on_delete=models.SET_NULL, related_name="milestone", null=True)
    ...
    status = models.CharField(max_length=255, choices=MilestoneStatusChoices.choices, default=MilestoneStatusChoices.ACTIVE)

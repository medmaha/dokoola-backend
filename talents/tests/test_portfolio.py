...
class TalentPortfolioAPITestCase(APITestCase):
    ...
    def setUp(self):
        client = APIClient()
        self.user = User.objects.create_user(email='testuser@example.com', password='testpassword', username="testusername")
...
def get_other_talent():
    ...
    """
    other_user = User.objects.create_user(email='otheruser@example.com', password='otherpassword', username="otherusername")
